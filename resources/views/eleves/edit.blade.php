...
{{-- enctype="multipart/form-data" obligatoire car on peut changer la photo --}}
<form method="POST"
      action="{{ route('eleves.update', $eleve) }}"
      enctype="multipart/form-data">
    @csrf
    {{-- @method('PUT') : Laravel ne supporte pas PUT nativement en HTML,
         cette directive génère un champ caché _method=PUT que Laravel intercepte --}}
    @method('PUT')
    ...
    <div class="row g-4">
        ...
        <div class="col-md-8">
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <input
                                ...
                                {{-- old() : utilise la valeur resoumise si erreur,
                                     sinon la valeur actuelle de l'élève en base --}}
                        ...
                        <div class="col-md-6">
                            ...
                            <input
                                ...
                                {{-- format('Y-m-d') : le champ date HTML attend ce format --}}
                        ...
                        <div class="col-md-6">
                            ...
                            >
                                ...
                                @foreach($classes as $classe)
                                    <option
                                        value="{{ $classe->id }}"
                                        {{-- Pré-sélectionne la classe actuelle de l'élève --}}
            ...
            {{-- Récapitulatif financier (lecture seule, informatif) --}}
            <div class="card border-0 shadow-sm mt-4
        ...
        <div class="col-md-4">
            ...
            {{-- Zone de danger : suppression de l'élève --}}
    ...
    function previewPhoto(input) {
        if (input.files && input.files[0]) {
            ...
            reader.onload = function(e) {
                {{-- Remplace le contenu du cercle par la nouvelle image --}}
                preview.innerHTML = `
